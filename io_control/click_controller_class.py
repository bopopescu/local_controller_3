...
class Click_Controller_Class:
    
   def __init__(self,name, new_instrument, slave, ip, port = 5005  ):
        self.name            = name
   ...
   def turn_on_valves( self, valve_list ):
      pass

   def turn_off_valves( self,  valve_list  ):
      pass
   ...
   def read_wd_flag( self ):
      pass
      

   def write_wd_flag( self):
       pass
...
if __name__ == "__main__":     
   ...
   slave_class   = Click_Controller_Class(client_driver,100,"192.168.1.82",5005)
